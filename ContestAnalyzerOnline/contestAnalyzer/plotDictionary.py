...
plotDictionary.addPlot("plot_qsos_vs_time__band___continent", ContestAnalyzerOnline.contestAnalyzer.plotLibrary.plot_qsos_vs_time__band___continent.plot_qsos_vs_time__band___continent("plot_qsos_vs_time__band___continent"))
